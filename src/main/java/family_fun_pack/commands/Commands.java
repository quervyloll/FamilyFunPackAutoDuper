...
public class Commands {
  ...
  public Commands() {
    ...
    this.registerCommand(new RdCommand());
    this.registerCommand(new ChestCommand());
    this.registerCommand(new DelayCommand());
    this.registerCommand(new DebugCommand());
    this.registerCommand(new filldelaycommand());
    this.registerCommand(new BtpCommand());
    this.registerCommand(new BedCommand());
    this.registerCommand(new BCCommand());
    this.registerCommand(new MountBedDelayCommand());
    this.registerCommand(new ConixCommand());
    this.registerCommand(new kickmode());
    this.registerCommand(new kickdelayCommand());
    this.registerCommand(new checkitemsCommand());
  }
