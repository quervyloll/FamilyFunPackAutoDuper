...
import static family_fun_pack.commands.AdCommand.mc;
  ...
  public void onConnect(FMLNetworkEvent.ClientConnectedToServerEvent event) {
    ...
    if(!this.isConnected) {
      ...
      try {
        ...
        if(old instanceof NettyPacketDecoder) {
        ...
        if(old instanceof NettyPacketEncoder) {
        ...
        if(old instanceof NettyVarint21FrameEncoder) {
