...
public class RotationUtil{
    ...
    public static Vec3d getEyesPos() {
        return new Vec3d(mc.player.posX, mc.player.posY + (double) mc.player.getEyeHeight(), RotationUtil.mc.player.posZ);
    }
    ...
    public static float[] getLegitRotations(Vec3d vec) {
        ...
        return new float[]{mc.player.rotationYaw + MathHelper.wrapDegrees(yaw - RotationUtil.mc.player.rotationYaw), RotationUtil.mc.player.rotationPitch + MathHelper.wrapDegrees(pitch - RotationUtil.mc.player.rotationPitch)};
    }
    ...
    public static float[] calcAngle(Vec3d from, Vec3d to) { //for some reason it doesnt let me use this method in MathUtil, so i had to copy it
